GNU Aspell 0.60 Azerbaijani (Azərbaycanca) Dictionary Package
Version 0.02-0
2004-08-17
Maintained By:
  Orkhan Jafarov <oceferov at yahoo com>
...
Wordlist URL: http://borel.slu.edu/crubadan/
Source Verson: 0.02
This word list is considered accurate but incomplete.

This is the Azerbaijani dictionary for Aspell.  It requires Aspell 
...
After the dictionaries are installed you can use the main one (az) by
setting the LANG environmental variable to az or running Aspell
with "--lang=az".  You may also chose the dictionary directly
